        ...
        @if($year3)
            ...
            <div style="margin-left: 2cm; margin-right: 2cm; font-family: calibri; ">
                ...
                <form action="{{ route('print', [$student->id]) }}" method="post">
                    @csrf
                    <div class="col">
                        <button type="submit" class="btn btn-default" id="printPageButton" onClick="myPrintable()">Print Transcript</button>
                    </div>
                </form>
            </div>
        @endif
